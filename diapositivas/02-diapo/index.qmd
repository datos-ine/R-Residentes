---
pagetitle: "Tipos de datos específicos"
...
##  {#intro-curso .invert data-menu-title="Introducción al curso y repaso"}

[**Tipos de datos específicos**]{.custom-title}

[***Encuentro 2***]{.custom-subtitle}
...
![](images/lubridate1.png){.absolute top="300" left="1300" width="650"}
...
![](images/lubridate.svg){.absolute top="350" left="300" width="200"}
...
![](images/stringr.png){.absolute top="50" left="1500" width="200"}



<br> <br> <br> <br> El paquete **stringr** se instala y activa cuando ejecutamos `library(tidyverse)`.
...
![](images/expreg1.PNG){.absolute top="700" left="600" width="850"}
...
![](images/str_detect.png){.absolute top="530" left="450" width="900"}
<br>
...
![](images/naniar_logo.png){.absolute top="20" left="1500" width="200"}
...
![](images/naniar.png){.absolute top="550" left="480" width="950"}
...
datos <- readxl::read_excel("base2023r.xlsx")
library(naniar)
