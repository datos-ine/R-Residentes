---
pagetitle: "Exploración, depuración y gestión de tablas de datos"
format: 
  revealjs:
    self-contained: true
    width: 1920
...
##  {#intro-diapo .invert data-menu-title="Exploración, depuración y gestión de tablas de datos"}

[**Gestión de tablas de datos**]{.custom-title}

[***Encuentro 3***]{.custom-subtitle}
...
![](images\Ordenar_datos.PNG){.absolute top="150" left="1250" width="800"}
...
![](images\tidy_data.PNG){.absolute top="650" left="300" width="1200"}
