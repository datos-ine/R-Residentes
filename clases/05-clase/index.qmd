...
![](types.png){fig-align="left" width=30%}
...
![[Artwork por \@allison_horst](https://allisonhorst.com/)](lubridate.PNG){width=40%}
...
Pero lo más útil es la divisón modular para redondear y quedarnos solo con los años:
...
![[Artwork por \@allison_horst](https://allisonhorst.com/)](stringr2.PNG){width=40%}
...
![[Artwork por \@allison_horst](https://allisonhorst.com/)](stringr.PNG){width=40%}
...
![[Artwork por \@allison_horst](https://allisonhorst.com/)](forcats.PNG){width=40%}
...
datos <- read_excel("Base_factores.xlsx",sheet = 1, col_names = T)
