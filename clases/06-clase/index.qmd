...
Por el lado gráfico, tiene uno muy interesante porque visualiza las relaciones de los valores ausentes de las variables. Se llama `gg_miss_upset()` y genera un gráfico **Upset** en función de la existencia de valores NA.
