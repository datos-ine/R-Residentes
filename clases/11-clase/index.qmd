...
Iniciamos activando paquetes, en este caso vamos hacerlo con **tidyverse**, **readxl** para leer archivos Excel y con un paquete específico que nos va a servir para el ajuste directo que se llama **PHEindicatormethods**.
...
2. Usamos `cur_interval()` para crear intervalos de clase cada 5 años (cerrados a izquierda y abiertos a derecha). Produce salidas tipo \[0,5\] que necesitamos convertir en etiquetas iguales a la de la variable `GRUPEDAD` de **poblaciones**, es decir 0-4.
