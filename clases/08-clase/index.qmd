...
![](images/for.png){fig-align="center" width="400"}
...
![](images/while.png){fig-align="center" width="400"}
...
![](images/map.png){fig-align="center" width="400"}
...
![](images/poblaciones.PNG){fig-align="center" width="700"}
...
hojas <- excel_sheets("data/c2_proyecciones_prov_2010_2040.xls")[-(1:2)]
```
...
```{r}
#| message: false
grupo_edad <- read_excel("data/c2_proyecciones_prov_2010_2040.xls", 
...
for (i in 1:length(hojas)) {
  datai <- read_excel("data/c2_proyecciones_prov_2010_2040.xls", 
