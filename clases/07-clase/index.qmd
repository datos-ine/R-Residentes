...
![](skimr.png){fig-align="center" width=10%}
...
![](dlookr.PNG){fig-align="center" width=10%}
...
![](datacleaning.jpg){fig-align="center" width=50%}
...
![](flujo.png){fig-align="center" width=80%}
...
![](tidy_data.PNG){fig-align="center" width=60%}
...
No. No lo hace porque lo que vemos como cabecera de columnas en 2010, 2011, etc. son categorías de la variable año (**year**) y no nombres de variables.
...
Los problemas comunes en tabla "desordenadas" de datos son:

- Una variable se extiende por varias columnas.

- Una observación está dispersa entre múltiples filas

El paquete **tidyr** de tidyverse resuelve estos problemas y mediante sus funciones **pivot_** podemos pivotear las tablas a lo "ancho" o "largo".
...
El paquete **datos** tiene una serie de datasets para ejemplificar. La tabla1
...
![](tabla_longer.png){fig-align="center" width=60%}
...
![](tabla_wider.png){fig-align="center" width=60%}
